...
def visualize_chain_ladder(triangle):
    ...
    # Heatmap
    plt.figure(figsize=(12, 8))
    sns.heatmap(projected_triangle, cmap='coolwarm', annot=True, fmt=".1f", linewidths=0.5, linecolor='black')
    ...
    sns.barplot(x=ibnr_reserve.index, y=ibnr_reserve.values, palette="Blues_d")
...
def visualize_bf_method(triangle):
    ...
    plt.figure(figsize=(10, 6))
    sns.barplot(x=bf_reserves.index, y=bf_reserves.values, palette="Blues_d")
    ...
    plt.figure(figsize=(10, 6))
    sns.barplot(x=bf_ultimate_claims.index, y=bf_ultimate_claims.values, palette="Greens_d")
...
def visualize_loss_ratio(df):
    ...
    plt.figure(figsize=(10, 6))
    sns.barplot(x=loss_ratios.index, y=loss_ratios.values, palette="Reds_d")
    ...
    plt.figure(figsize=(10, 6))
    sns.barplot(x=expected_claims.index, y=expected_claims.values, palette="Purples_d")
